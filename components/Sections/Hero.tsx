    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#F8F6F2] to-[#F4F1EA] pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {mathEquations.map((equation, index) => (
          <motion.div
            key={index}
            className="absolute text-[#9CA98C]/[0.08] font-mono font-bold whitespace-nowrap"
            initial={{
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(15)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-2 h-2 bg-[#9CA98C]/20 rounded-full"
            initial={{ 
              x: Math.random() * (typeof window !== 'undefined' ? window.innerWidth : 1200),
              y: Math.random() * (typeof window !== 'undefined' ? window.innerHeight : 800),
              opacity: 0
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <motion.div
            ...
            className="mb-4"
          >
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-[#434343] font-['Times_New_Roman',serif] tracking-wide leading-tight">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-black bg-gradient-to-r from-[#434343] via-[#666666] to-[#434343] bg-clip-text text-transparent font-['Georgia',serif] leading-tight">
              Pompilio Ortega
            </h2>
          </motion.div>
          ...
          >
            <div className="text-2xl md:text-3xl lg:text-4xl font-light text-[#434343] font-sans">
              Ofrecemos
            </div>
            <div className="relative h-16 flex items-center justify-center min-w-[400px]">
              <AnimatePresence mode="wait">
                <motion.span
                  ...
                  className="absolute text-2xl md:text-3xl lg:text-4xl bg-gradient-to-r from-[#9CA98C] to-[#7D8A6E] bg-clip-text text-transparent font-bold font-['Georgia',serif] whitespace-nowrap"
                >
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-[#434343]/80 mb-12 max-w-3xl mx-auto leading-relaxed font-sans text-center px-4"
        >
          Por más de seis décadas, formamos mentes analíticas y líderes del mañana 
          mediante una educación basada en matemáticas, pero sobre todo valores y diciplina.
        </motion.p>
        ...
        >
          <motion.button
            ...
            className="group px-8 py-4 bg-gradient-to-r from-[#434343] to-[#666666] text-white font-bold shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center gap-3 font-sans"
            style={{ borderRadius: '8px' }}
          >
          ...
          <motion.button
            whileHover={{ scale: 1.05, y: -2 }}
            whileTap={{ scale: 0.98 }}
            className="group px-8 py-4 bg-white/90 backdrop-blur-md text-[#434343] font-bold border border-[#9CA98C]/30 shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-3 font-sans"
            style={{ borderRadius: '8px' }}
          >
        ...
        >
          <motion.div
            ...
            className="text-[#9CA98C]"
          >
            <ChevronDown className="w-6 h-6" />
          </motion.div>
          <span className="text-sm text-[#434343]/70 font-medium font-sans">
            Explorar más
          </span>
        </motion.div>
      </div>
      ...
      <motion.div
        ...
        className="absolute bottom-8 left-1/2 transform -translate-x-1/2 h-0.5 bg-gradient-to-r from-transparent via-[#9CA98C] to-transparent"
      />
    </section>
  );
}