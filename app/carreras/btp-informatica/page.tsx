// app/carreras/btp-informatica/page.tsx
'use client';
...
export default function BTPInformaticaPage() {
      ...
      <AnimatePresence>
        {!cargando && (
          <motion.div className="w-full h-full bg-white">
            <motion.iframe
              src="https://institutopompilioortega.blogspot.com/2025/11/bachillerato-tecnico-profesional-en_6.html"
              className="w-full h-full border-0"
              title="BTP en Informática"
