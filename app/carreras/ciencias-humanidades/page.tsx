// app/carreras/ciencias-humanidades/page.tsx
'use client';
...
export default function CienciasHumanidadesPage() {
      ...
      <AnimatePresence>
        {!cargando && (
          <motion.div className="w-full h-full bg-white">
            <motion.iframe
              src="https://institutopompilioortega.blogspot.com/2025/11/bachillerato-en-ciencias-y-humanidades.html"
