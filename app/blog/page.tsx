...
export default function BlogPage() {
  ...
  return (
    <div className="fixed inset-0 z-50">
        ...
        {cargando && (
          ...
          >
            ...
            >
              ...
              >
                Cargando noticias y actualizaciones...
              </motion.p>
      ...
      {/* Contenido principal - Blog en fullscreen */}
      <AnimatePresence>
        {!cargando && (
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            {/* Iframe del Blog en pantalla completa */}
            <motion.iframe
              initial={{ opacity: 0, scale: 0.95 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.6, delay: 0.3 }}
              src="https://pompilioortegablog.blogspot.com/"
              className="w-full h-full border-0"
              title="Blog Institucional - Instituto Pompilio Ortega"
              ...
              {!iframeCargado && (
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 text-lg">Cargando blog...</p>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
